...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '061b7375-9a55-41bf-8b53-b9b1954c0465' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('f82e2cd9-a35d-4ea3-9d0d-be43dc027139');
      cy.get(`[data-cy="name"]`).should('have.value', 'f82e2cd9-a35d-4ea3-9d0d-be43dc027139');
